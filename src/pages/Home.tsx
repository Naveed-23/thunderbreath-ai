...
export function Home() {
  ...
  return (
    <div className="relative min-h-screen bg-gradient-to-br from-gray-900 to-gray-950 flex items-center justify-center p-4">
  <div className="absolute inset-0 z-0">
    <Spark />
  </div>
  
  <div className="max-w-2xl w-full z-10"> {/* Increased z-index to keep it above particles */}
